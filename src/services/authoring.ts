      ...
      items: {
        ...
        properties: {
          ...
          stem: {
            type: Type.STRING,
            description:
              "the question as the student sees it; self-contained (restate any numbers a prior question set up)",
          },
          referenceAnswer: {
            type: Type.STRING,
            description:
